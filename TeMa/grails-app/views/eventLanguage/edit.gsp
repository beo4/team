	...
	<body>
		<div class="row-fluid">
			...
			<div class="span9">
				...
				<fieldset>
					<g:form class="form-horizontal" action="edit" id="${eventLanguageInstance?.id}" >
						<g:hiddenField name="version" value="${eventLanguageInstance?.version}" />
						<fieldset>
							<f:all bean="eventLanguageInstance"/>
