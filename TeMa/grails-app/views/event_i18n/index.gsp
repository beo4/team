...
<html>
    ...
    <body data-ng-app="scaffolding" data-base-url="${createLink(uri: '/event_i18n/')}">
        <a href="#list-event_i18n" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
        <div class="row-fluid">
        	<div class="span3">
