...
<html>
    ...
    <body data-ng-app="scaffolding" data-base-url="${createLink(uri: '/resourceOption_i18n/')}">
        <a href="#list-resourceOption_i18n" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
        <div class="row-fluid">
        	<div class="span3">
